      ...
      <div className={styles.root__thickness}>
        <div className={styles.root__preview}>
          <div className={styles.root__previewThickness} style={{ backgroundColor: activeColor, height: thickness }}>
            <div className={styles.root__previewThickness_top} style={{ transform: `rotate(${-0.8 + (10 - thickness) / 10}deg)` }} />
            <div className={styles.root__previewThickness_bottom} style={{ transform: `rotate(${0.8 - (10 - thickness) / 10}deg)` }} />
          </div>
        </div>
