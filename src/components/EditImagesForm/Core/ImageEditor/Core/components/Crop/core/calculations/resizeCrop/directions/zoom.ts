...
import { imageEditorZoomPixelStep } from '../../../../../../../../../../../utils/consts';
import { degrees_to_radians } from '../../../../../../calculationFunctions/converters';
import { TZoomProperties, TZoomStep } from '../../../../../../Types/Types';
...
export const zoomOut = (crop: ICropShape, image: IDynamicShape & { angle: number }, stepProperties: TZoomProperties) => {
  ...
  let relWidth = (crop.width / 2 + imageEditorZoomPixelStep) / image.startPosition.width;
